    ...
    <v-row class="fill-height" align="center" justify="center">
      ...
      <v-col cols="12" sm="8" md="4">
          <v-row align="center" justify="center" class="mb-2">
            <v-img src="/WAGRO.png" alt="Wagro logo" aspect-ratio="1" max-width="100" contain></v-img>
          </v-row>
          <v-card-text class="pt-8 rounded-lg" style="background: #ffffff33; backdrop-filter: blur(10px); border: 1px solid #E7E8EB; box-shadow: 0 25px 50px -12px rgb(0 0 0 / 5%);">
            <h4 class="text-md-center text-h5" style="color: #0A1B39">Sign In</h4>
            <h5 class="text-center text-subtitle-2 pt-2" style="color: #6B7280">Please enter below details to access the dashboard</h5>
              ...
              <v-col cols="12" sm="8">
                <v-form @submit.prevent="submitHandler" ref="form">
                  <v-text-field
                    ...
                    dense
                    color="blue"
                    v-model="model.user.usernameOrEmail"
                    prepend-inner-icon="mdi-account"
                    autocomplete="false"
                    class="mt-12 mb-2 login_input"
                    clearable
                  ></v-text-field>
                  ...
                  <v-row class="mb-2">
                    ...
                    <v-col
                      ...
                      class="d-flex justify-center align-center"
                    >
                      <span class="caption blue--text" color="blue"
                  ...
                  <v-btn
                    ...
                    variant="outlined">Test</v-btn
                  >
                </v-form>
  
                <h5 class="text-center grey--text mt-4 mb-3 text-uppercase font-weight-medium position-relative divider" style="color: #9ca3af;">Or log in using</h5>
      ...
      methods: {
        submitHandler() {
          if(this.$refs.form.validate()){
            ...
            axios.post(`${this.serviceapi}/auth/login`, data, {
