                                    ...
                                    <div class="my-8">
                                        <v-row no-gutters class="ga-6">
                                            <v-col cols="5">
                                                ...
                                                <v-text-field v-model="form.firstName" density="compact"
                                                    placeholder="John" variant="outlined" :rules="[rules.required]"
                                                    required></v-text-field>
                                            </v-col>

                                            <v-col class="7">
                                                <h4 class="description mb-2">Επωνυμο</h4>
                                                <v-text-field v-model="form.lastName" density="compact"
                                                    placeholder="Doe" variant="outlined" :rules="[rules.required]"
                                                    required></v-text-field>
                                            </v-col>
                                        ...
                                        <v-row>
                                            <v-col>
                                                ...
                                                <v-text-field v-model="form.email" density="compact"
                                                    :rules="[rules.required]" placeholder="john.doe@example.com"
                                        ...
                                        <v-row>
                                            <v-col>
                                                ...
                                                <v-text-field v-model="form.uid" density="compact"
                                                    placeholder="FM-12345" variant="outlined" disabled
                                                    hide-details></v-text-field>
                                                <v-btn variant="text" class="float-left generate-link" size="small"
                                                    @click="generateUid">
                                            ...
                                            <v-col>
                                                ...
                                                <v-select v-model="form.role" density="compact"
                                                    placeholder="Select Role" variant="outlined" :items="roles"
                                                    :rules="[rules.required]" item-title="label" disabled></v-select>
                                            </v-col>
                                        </v-row>
                                    </div>
                    ...
                    <v-container class="pa-0">
                        <v-row class="d-flex justify-space-between">
                            ...
                            <v-col class="d-flex justify-end">
                                <v-menu offset-y class="card-menu" :offset="[-8, -12]" location="bottom end"
                                    scroll-strategy="none">
                                    <template v-slot:activator="{ props }">
                                        <v-btn v-bind="props" icon="mdi-dots-vertical" size="medium" color="#94a3b8"
                                            variant="plain"></v-btn>
                                    </template>
                                    ...
                                    <v-card class="rounded-lg overflow-hidden" max-width="200">
                                        <v-list min-width="200" class="overflow-hidden px-0 pb-1" density="compact">
                                            <v-list-item @click="openUpdateUserModal(user)">
                                                <template v-slot:prepend>
                                            ...
                                            <v-list-item color="primary" rounded="shaped">
                                                ...
                                                <v-list-item-title class="text-sm">Αλλαγή κωδικού</v-list-item-title>
                                            </v-list-item>
